...
class PointLeaderBoardListRowWidget extends StatelessWidget {
  final PointLeaderBoardUserEntity user;
  const PointLeaderBoardListRowWidget({required this.user, super.key});
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            LabelGlobalWidget(title: user.name),
            LabelGlobalWidget(title: user.point.toString()),
          ],
        ),
      ),
    );
